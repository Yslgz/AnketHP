...
namespace Internet_1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, SurveyRepository surveyRepository, IMapper mapper, IConfiguration config, INotyfService notyf, IFileProvider fileProvider, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, SignInManager<AppUser> signInManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            surveys = surveys.Where(s => s.IsActive == true).ToList();
